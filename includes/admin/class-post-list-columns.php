...
class PRAutoBlogger_Post_List_Columns {
	...
	public function on_column_styles(): void {
		...
		echo '<style>'
			...
			. '.column-author{width:6%}'
			. '.column-categories{width:7%}'
			. '.column-tags{width:9%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}'
			. '.column-date{width:8%}'
			. '.column-prab_writing_model{width:85px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
			. '.column-prab_image_model{width:85px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
			. '.column-prab_cost{width:50px;white-space:nowrap;overflow:visible}'
			. '.column-taxonomy-peptide_topic{width:75px}'
